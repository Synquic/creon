  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://dhruvthc.app.n8n.cloud/webhook/5af31bd0-d969-40b7-929d-4fdb65433876",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        setIsSubmitted(true);
        toast.success(
          "You will receive the notification shortly on email with analysis!"
        );
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Enter the influencer details to start tracking their performance
                and get analysis reports.
              </p>
            </div>
            ...
            {!isSubmitted ? (
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  {`You will receive the notification shortly on email with
                    analysis. Our team will process your request and send you
                    detailed insights about the influencer's performance.`}
                </p>
        ...
        >
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    {`Enter the influencer's name and your email address`}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    {`Our system analyzes the influencer's performance data`}
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-green-50 via-green-25 to-emerald-50 rounded-3xl p-6 shadow-lg border border-green-100/50 hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-3">
              {["Engagement rate analysis", "Audience demographics"].map(
                (feature, index) => (
