    ...
    <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {stats.totalClicks ||
                        links.reduce(
                          (sum: number, link: { clickCount: number }) =>
                            sum + link.clickCount,
                          0
                        )}
                    </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="h-64 bg-gradient-to-r from-chart-2 to-primary rounded-lg flex items-center justify-center">
            <div className="text-center">
              <ChartAreaIcon className="w-12 h-12 text-white mx-auto mb-2" />
        ...
        >
          ...
          <div className="space-y-3">
            {links
              ...
              .sort(
                (a: { clickCount: number }, b: { clickCount: number }) =>
            ...
            {links.filter((link: { isActive: boolean }) => link.isActive)
              .length === 0 && (
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {links.slice(0, 10).map((link: LinkData) => (
