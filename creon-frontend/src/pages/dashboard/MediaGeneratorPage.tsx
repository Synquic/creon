            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Fill in the details to generate personalized media content for your campaign.
                </p>
              </div>
              ...
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  {/* Variation Count */}
                  <div>
                    <label htmlFor="variationCount" className="block text-sm font-semibold text-gray-700 mb-2">
                      Variation Count *
                    </label>
                  ...
                  {/* Pointers */}
                  <div>
                    <label htmlFor="pointers" className="block text-sm font-semibold text-gray-700 mb-2">
                      Key Points
                    </label>
                    <textarea
                      id="pointers"
                  ...
                  {/* CTA */}
                  <div>
                    <label htmlFor="cta" className="block text-sm font-semibold text-gray-700 mb-2">
                      Call to Action *
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  {/* Button Text */}
                  <div>
                    <label htmlFor="buttonText" className="block text-sm font-semibold text-gray-700 mb-2">
                      Button Text *
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  {/* Person Details */}
                  <div>
                    <label htmlFor="personDetails" className="block text-sm font-semibold text-gray-700 mb-2">
                      Person Details
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  {/* Other Requirements */}
                  <div>
                    <label htmlFor="otherRequirements" className="block text-sm font-semibold text-gray-700 mb-2">
                      Other Requirements
                    </label>
                    <textarea
                  ...
                  {/* Resolution */}
                  <div>
                    <label htmlFor="resolution" className="block text-sm font-semibold text-gray-700 mb-2">
                      Resolution *
                    </label>
                    <select
                      id="resolution"
                  ...
                  <div>
                    <label htmlFor="wantHeadlineVariations" className="block text-sm font-semibold text-gray-700 mb-2">
                      Want Headline Variations
                    </label>
                    <select
                ...
                >
                  ...
                  <p className="text-gray-600 mb-6">
                    Your media generation request has been submitted successfully. You will receive the generated media content via email shortly.
                  </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Provide your content requirements and preferences</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Our AI generates personalized media content</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Receive Content</h4>
                    <p className="text-gray-600 text-sm">Get your generated media delivered to your email</p>
                  </div>
                </div>
              </div>
            </div>
