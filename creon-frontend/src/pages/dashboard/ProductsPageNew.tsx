...
const productSchema = z.object({
  ...
  affiliateUrl: z.string().url('Please enter a valid URL').min(1, 'URL is required'),
...
const ProductsPageNew: React.FC = () => {
  ...
  const onSubmit = async (data: ProductFormData) => {
    ...
    try {
      if (editingProduct) {
        await updateProductMutation.mutateAsync({ id: editingProduct._id, data: cleanData });
      } else {
  ...
  const handleToggleActive = async (product: Product) => {
    await toggleProductMutation.mutateAsync({ id: product._id, isActive: !product.isActive });
  };
    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your products and affiliate links</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-8 max-w-md mx-auto">
              Start showcasing your products to your audience. Add affiliate links, pricing, and descriptions to boost your sales.
            </p>
            <Button
              onClick={() => setShowCreateForm(true)}
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        onClick={() => window.open(`/dashboard/analytics/product/${product._id}`, '_blank')}
