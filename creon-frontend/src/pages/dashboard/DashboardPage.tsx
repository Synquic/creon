...
const DashboardPage: React.FC = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      bgColor: 'from-green-700/10 to-green-800/5',
      iconBg: 'bg-green-700',
      subtitle: 'In Store',
      growth: '+8%',
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:block">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 py-3 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-2"
                >
          ...
          {statCards.map((stat, index) => (
            ...
            >
              <div className="relative group overflow-hidden bg-white rounded-3xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${stat.bgColor} opacity-50 rounded-3xl`}></div>
                ...
                <div className="relative p-6">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 mb-1 uppercase tracking-wide">{stat.title}</h3>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-emerald-600 text-sm font-semibold">↗ {stat.growth}</span>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div className="space-y-4">
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white py-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 mt-6"
                >
                  View Full Analytics
                </motion.button>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50 via-green-25 to-emerald-50 rounded-3xl p-6 shadow-lg border border-green-100/50 hover:shadow-xl transition-all duration-300">
              ...
              <div className="space-y-4">
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white py-3 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  Complete Profile
                </motion.button>
              </div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  >
                    ...
                    <span className="text-gray-800 font-semibold">{action.text}</span>
                  </motion.button>
                ))}
              </div>
            </div>
        ...
        >
          <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-green-500 font-semibold">↗ 23% Growth</span>
                <span className="text-gray-500">this month</span>
              </div>
            </div>
            
            <div className="h-64 flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border-2 border-dashed border-green-200">
